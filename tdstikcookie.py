...
try:
    ...
    if platform.system() == 'Windows': 
        ...
        input('Thư Viện Chromium nặng lắm à,gần 1gb á,..')            
...
def Banner():
    banner = """
\033[1;35m╔═══════════════════════════════════════════════════════════════════════╗
\033[1;35m║ TOOL >>> [ TRAODOISUB TIKTOK AUTO ]                                   ║
\033[1;35m║ THỜI GIAN >>> [ {} ]           ║
\033[1;35m║ PHIÊN BẢN PYTHON >>> [ {} ]                                           ║   
\033[1;35m║ PHIÊN BẢN TOOL >>> [ BETA ]                                              ║   
\033[1;35m╚═══════════════════════════════════════════════════════════════════════╝
...
def custom_delay(delay):
    for remaining in range(delay, 0, -1):
        ...
        time_str = f"[P-TOOL][DELAY][{mins:02}:{secs:02}]"
